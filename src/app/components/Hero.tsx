      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)] lg:gap-16">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex min-h-10 items-center rounded-full border border-border bg-card px-3 py-2 text-[10px] sm:text-xs font-medium uppercase tracking-[0.10em] sm:tracking-[0.18em] text-muted-foreground whitespace-nowrap">
              MTECH IT SOLUTIONS
            </span>
            <span className="inline-flex min-h-10 items-center rounded-full border border-border bg-card px-3 py-2 text-[10px] sm:text-xs font-medium uppercase tracking-[0.10em] sm:tracking-[0.18em] text-muted-foreground whitespace-nowrap">
